...
function NavBar(){
    ...
    const nav = [{
      ...
      {
        icon:"./src/img/Explore.svg",
        action:"Explorar"
      },
      {
        icon:"./src/img/Reels.svg",
        action:"Reels"
      },
      {
        icon:"./src/img/Messages.svg",
        action:"Mensajes"
      },
      {
      ...
      {
        icon:"./src/img/New post.svg",
        action:"Crear"
      },
      {
        icon:"./src/img/Profile.svg",
        action:"Perfil"
      }]

    const toggle = [     {
        icon:"./src/img/Union.svg",
        action:"Más"
      }]
    ...
    return (
        ...
        {
            nav.map((item)=>
            <NavItem icon={item.icon} action={item.action}  />
            )
        }
        
        {
            toggle.map((item)=> <ToggleMenu icon={item.icon} action={item.action} />)
        }
